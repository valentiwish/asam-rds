<template>
    <div>
        ...
        <div class="page-search">
            ...
            <div class="page-search-content">
                <Form ref="s" v-model="s" :label-width="80"  @submit.native.prevent="submit">
                    ...
                    <FormItem label="任职条件">
                        <Input v-model.trim="s.conditions" maxlength="50" placeholder="请输入任职条件"></Input>
                    </FormItem>
                </Form>
        ...
        <!-- 新增属性-->
        <Modal v-model="modal_add" title="新增工种信息">
        ...
        <!-- 更新属性-->
        <Modal v-model="modal_update" title="更新工种信息">
        ...
        <!-- 查看属性-->
        <Modal v-model="modal_view" title="查看工种信息" >
...
import { getRouteTitleHandled } from "../../../libs/util";
    ...
    export default {
        ...
        data: function() {
            ...
            return {
                ...
                "gridOption": {
                    "url":"/service_user/profession/list",
                    "data": [],
                    "columns": [
                        {
                            "title": "名称",
        ...
        methods: {
            ...
            del: function(obj) {
                this.$Modal.confirm({
                    ...
                    content: '您确认删除此条数据？',
                    onOk: () => {
                        this.$ajax.post("/service_user/profession/delete", { 'id': obj.id })
                        .then((res) => {
            ...
            //以下二个是界面的方法
            search: function() {
                this.$refs.grid.load({ 'name': this.s.name,'conditions': this.s.conditions});
            },
            reset: function() {
                this.s.name = "";
                this.s.conditions = "";
